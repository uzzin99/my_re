...
<section>
	<div align="center"><br><br><br><br><br><br><br>
		<h1>🛵배달의민족🛵</h1><br>
		<form id=frmSignin method=get action="userSign">
			<table>
				<tr>
					<td><input type=submit name="Sign" class="sign" value="손님 회원가입" >
						<!-- <img class="click" src='https://cdn-icons.flaticon.com/png/512/3346/premium/3346862.png?token=exp=1658713153~hmac=e366db0ac3666f98d7e98281dd34f673'> -->
					</td>
				</tr>
				<tr>
					<td><input type=submit name="Sign" class="sign 2" value="사장님 회원가입">
						<!-- <img class="click" src='https://cdn-icons.flaticon.com/png/512/3346/premium/3346862.png?token=exp=1658713153~hmac=e366db0ac3666f98d7e98281dd34f673'> -->
					</td>
				</tr>
			</table>
			<br><br>
			<!-- <p><a href=login><input type=button class="back" value="뒤로가기"></a></p> -->
		</form>
	</div>
</section>
