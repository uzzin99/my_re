...
<section><br>
    <img class="receipt" src="image/영수증.png" >
    <div style="position: relative; margin-top: 80px;">
        <h3 align="center">주문완료📑</h3>
        <table class="endlist">
            <tr><th>메뉴명</th><th>수량</th><th>금액</th></tr>
            <c:forEach var="OD" items='${detail}'>
                <tr><td style="text-align:left;">${OD.OName}</td><td>${OD.OQty}</td><td>${OD.qtyPrice} 원</td></tr>
            </c:forEach>

            <tr><td colspan="2" style="text-align:right;">총 결제금액:</td><td>${hab} 원</td></tr>
            <tr><td></td><td></td><td style="text-align:center;">주문번호: ${ose}</td></tr>

<%--            <tr><td style="width: 100px;">가게이름</td><td>${blist.SName}</td></tr>--%>
<%--            <tr><td>예약날짜</td><td>${blist.HDate}</td></tr>--%>
<%--            <tr><td>예약시간</td><td>${blist.HTime}</td></tr>--%>
<%--            <tr><td>예약번호</td><td>${blist.HSeqno}</td></tr>--%>
<%--            <tr><td>인원수</td><td>${blist.HPeople}</td></tr>--%>
<%--            <tr><td>예약자ID</td><td>${blist.MId}</td></tr>--%>
<%--            <tr><td>예약자</td><td>${blist.HOnepeople}</td></tr>--%>
<%--            <tr><td>연락처</td><td>${blist.HMobile}</td></tr>--%>
        </table>
        <p align="center" style="margin-top: 40px;"><img class="bacon" src="https://www.pngmart.com/files/10/Barcode-PNG-Pic.png"></p>
    </div>
</section>
